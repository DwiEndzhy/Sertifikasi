...
class Sertifikasi
{
    ...
    public function getSertifikasiBerdasarkanNama()
    {
        if (isset($_GET['nama_sertifikasi'])) {
            $nama_sertifikasi = $_GET['nama_sertifikasi'];
            $sql = "select * from sertifikasi where nama_sertifikasi like '%$nama_sertifikasi%' ";
    ...
    {
        if (isset($_GET['dosen_pengampu'])) {
            $dosen_pengampu = $_GET['dosen_pengampu'];
            $sql = "select * from sertifikasi where dosen_pengampu like '%$dosen_pengampu%' ";
            $stmt = $this->conn->prepare($sql);
            $stmt->execute();
            return $stmt;
        }
